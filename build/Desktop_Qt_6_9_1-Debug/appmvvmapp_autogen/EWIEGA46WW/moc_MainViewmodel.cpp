...
void MainViewModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (MainViewModel::*)()>(_a, &MainViewModel::nameChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (MainViewModel::*)()>(_a, &MainViewModel::passChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (MainViewModel::*)()>(_a, &MainViewModel::loginSuccess, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (MainViewModel::*)()>(_a, &MainViewModel::loginFailed, 3))
            return;
    }
    if (_c == QMetaObject::ReadProperty) {
        ...
        case 1: *reinterpret_cast<QString*>(_v) = _t->pass(); break;
        default: break;
        }
    }
    if (_c == QMetaObject::WriteProperty) {
        ...
        case 1: _t->setPass(*reinterpret_cast<QString*>(_v)); break;
        default: break;
        }
    }
}
...
// SIGNAL 1
void MainViewModel::passChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void MainViewModel::loginSuccess()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void MainViewModel::loginFailed()
{
